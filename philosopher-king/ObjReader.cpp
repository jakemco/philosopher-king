...
void ObjReader::readObj(char* fileName, int &nVertices, float **vertices,
...
float const * const ObjReader::getVertices()  { return vertices; }
float const * const ObjReader::getNormals()   { return normals; }
